...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-green-400 to-teal-500 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">CottonRoad</h3>
            <p className="text-white/90">
              Your one-stop destination for premium clothing and fashion accessories.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/cart" className="text-white/90 hover:text-white transition-colors">
                  Cart
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/shop?category=Men" className="text-white/90 hover:text-white transition-colors">
                  Men's Collection
                </Link>
              </li>
              <li>
                <Link to="/shop?category=Women" className="text-white/90 hover:text-white transition-colors">
                  Women's Collection
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2 text-white/90 mb-2">
